"""ADK tool — score one audio frame with a :class:`Detector` and audit it.

Feature: F1 (Real-Time Audio Deepfake Detection)
ACM: 1.2, 1.3, 1.6, 3.1, 3.7
Scope: in-product.md
...
carrying score/state metadata only — never the waveform, MFCCs, or any
...
EVENT_NAME = "audio.detect"


def audio_detect(frame: Frame, *, detector: Detector, audit: AuditLog) -> DetectionResult:
